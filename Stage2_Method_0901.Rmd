...
# The information are summarised in "Participants".
# https://osf.io/vnbkm
...
## Update SP_V
SP_V <- #SP_V %>% group_by(Subject) %>%
  #right_join(
    subset(SP_V, Match != "F")
             #, by = "Subject")

## Stat information for Pariticipants and Intra-lab analysis sections
Raw_total <- SP_V %>%
