...
authornote: |
  ...
  **Ethical approval statement.** Authors who collected data on site and online had the ethical approval/agreement from the local institute. The latest status of ethical approval for all the participating authors is available at the public OSF folder (https://osf.io/e428p/ "IRB approvals" in Files).
...
- [Revision at early 2020](https://docs.google.com/document/d/1vOnRY5WVZkhCCipJwrBcbIoaC7hPagYD7tgIUc8zlRU/edit#)
...
```{r METHOD, child='Stage2_Method_0504.Rmd'}
```

```{r RESULTS, child='Stage2_Results_0504.Rmd'}
```
